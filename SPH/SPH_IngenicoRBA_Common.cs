...
namespace SPH {
    ...
    {
        /// <summary>
        /// Keep track of last message sent to device to
        /// be retried in the case of a NAK
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// Currently getting a signature. Data is often streamed from the
        /// device over multiple messages
        /// </summary>
        ...
        /// <summary>
        /// After receiving input from the device, automatically
        /// advance the device to the next step or screen. The
        /// alternative is to only advance steps or screen as 
        /// directed by messages from POS
        /// </summary>
        protected bool auto_state_change = true;

        /// <summary>
        /// This has to be stored temporarily because
        /// the PIN request screen requires it
        /// </summary>
        private string masked_pan = "";

        /// <summary>
        /// Place to drop signautre bitmap files
        /// </summary>
        private static String MAGELLAN_OUTPUT_DIR = "ss-output/";

        /// <summary>
        /// Config sequence to enable EBT cash. Spacing matters
        /// </summary>
        protected const string EBT_CA = "1 0 4  0  14 10000 1 1 1 0      0 132 0 1 0 D 0 0 406";

        /// <summary>
        /// Config sequence to enable EBT food. Spacing matters
        /// </summary>
        protected const string EBT_FS = "1 0 4  0  14     0 1 1 1 0      0 133 0 1 0 D 0 0 406";

        /// <summary>
        /// RBA_Stub uses an argument-less constructor
        /// </summary>
        public SPH_IngenicoRBA_Common() { }

        /// <summary>
        /// Port identifier constructor. Most setup is
        /// deferred to child class implementations
        /// </summary>
        /// <param name="p"></param>
        public SPH_IngenicoRBA_Common(string p) : base(p)
        {
            ...
            if (auto_state_change) {
                Console.WriteLine("SPH_Ingenico starting in AUTO mode");
            } else {
                Console.WriteLine("SPH_Ingenico starting in COORDINATED mode");
            }
        }
        ...
        /// <summary>
        /// Main thread to monitor device.
        /// Child class is responsible for entire
        /// implementation
        /// </summary>
        ...
        public void HandleMessageFromDevice(byte[] buffer)
        {
            ...
            if (this.verbose_mode > 0) {
                ...
                Console.WriteLine("LRC "+(CheckLRC(buffer)?"Valid":"Invalid"));
                Console.WriteLine();
            }
        ...
        /// Child class is responsible for the 
        /// implementation.
        /// </summary>
        ...
        /// <summary>
        /// Handle a message received from POS
        /// </summary>
        /// <param name="msg">The message</param>
        ...
        ***********************************************/
        ...
        /// <summary>
        /// Tell the device to go online/active
        /// </summary>
        ...
        /// <summary>
        /// Tell device to go offline/inactive
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Reset the device. This isn't a full reboot though
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// The device has a number of "screen lines" available
        /// to display text information during the transaction.
        ...
        /// <summary>
        /// Get the device status. This is used during signature
        /// capture to poll whether the signature is complete
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        */
        ...
        /// <summary>
        /// Put device into signature catpure mode
        /// </summary>
        ...
        /// <summary>
        /// Get a variable message which is like a configuration
        /// settings.
        /// </summary>
        /// <param name="var_code">identifier; should have length 6</param>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Set a variable message which is like a configuration setting
        /// </summary>
        /// <param name="var_code">identifier; should have length 6</param>
        /// <param name="var_value">new value</param>
        /// <returns>message bytes</returns>
        ...
        */
        ...
        /// <summary>
        /// Write from the device configuration
        /// Settings are identified by group and then 
        /// an index number within the group
        /// </summary>
        /// <param name="group_num">group number</param>
        /// <param name="index_num">index number</param>
        ...
        /// <summary>
        /// Display the choose card type screen
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        /// </summary>
        /// <param name="the_message">the text</param>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Write an approved message on screen
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Write a wait message on screen
        /// </summary>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Apply an update to the current screen. This
        /// can show, hide, or modify screen elements
        /// </summary>
        /// <param name="update">string describing changes</param>
        /// <returns>message bytes</returns>
        ...
        /// <summary>
        /// Read from variables in the device to determine
        /// how long the signature is
        /// </summary>
        /// <param name="status">Current device status</param>
        /// <param name="msg">Message received from device</param>
        ...
        /// <summary>
        /// Extract data from a signature block message and 
        /// feed it into the Signature object
        /// </summary>
        /// <param name="status">current device status</param>
        /// <param name="msg">Last message from device</param>
        ...
        /// <summary>
        /// Parse card info out of a larger message
        /// </summary>
        /// <param name="msg">Message from the device</param>
    ...
    /// <summary>
    /// An extra signature class designed to work with RBA's default
    /// output format
    /// </summary>
