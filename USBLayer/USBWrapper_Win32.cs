//-------------------------------------------------------------
// <copyright file="USBWrapper_Win32.cs" company="Whole Foods Co-op">
...
namespace USBLayer
{
    ...
    /// <summary>
    /// Wrapper for win32 environments
    /// </summary>
    public class USBWrapper_Win32 : IUSBWrapper
    {
        /// <summary>
        /// External structure for Layout
        /// </summary>
        ...
        /// <summary>
        /// External structure device interface
        /// </summary>
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        ...
        /// <summary>
        /// External structure for HID capabilities
        /// </summary>
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        ...
        /// <summary>
        /// External structure for interface details
        /// </summary>
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        ...
        /// <summary>
        /// External structure for broadcast interface
        /// </summary>
        ...
        public Stream GetUSBHandle(string filename, int report_size)
        {
            ...
            this.nativeHandle = CreateFile(filename, GENERIC_READ | GENERIC_WRITE, 0, IntPtr.Zero, OPEN_EXISTING, FILE_FLAG_OVERLAPPED, IntPtr.Zero);
            if (this.nativeHandle != InvalidHandleValue)
            {
                IntPtr lpData;
                if (HidD_GetPreparsedData(this.nativeHandle, out lpData))
                {
                    HidCaps oCaps;
                ...
                return new FileStream(this.safeHandle, FileAccess.Read | FileAccess.Write, report_size, true);
        ...
        /// Get device path
        /// </summary>
        /// <param name="hInfoSet">Pointer to hardware info</param>
        /// <param name="oInterface">Device interface</param>
